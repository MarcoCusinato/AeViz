...
def get_initial_parameters(path_folder):
    ...
    if 'NOTRINOPARS' in start_pars.keys():
        if start_pars['NOTRINOPARS']['OPMOD'] == 1:
            initial_parameters['notrino'] = {}
    ...
    if 'RMI_PARS' in start_pars.keys():
        initial_parameters['rhomin_neutrino'] = start_pars['RMI_PARS']['RHOMIN']
